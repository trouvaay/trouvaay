...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['short_name', 'first_image', 'store', 'click_count', 'is_published', 'is_featured', 'is_reserved', 'is_sold', 'current_price', 'added_date', 'pub_date', 'is_landing', 'is_featured',]
