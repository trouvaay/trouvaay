...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['short_name', 'first_image', 'store', 'is_published', 'is_hot', 'is_featured', 'is_reserved', 'is_sold', 'current_price', 'added_date', 'pub_date', 'is_landing', 'is_featured',]
    ...
    list_editable = ['current_price', 'is_published', 'is_hot', 'is_landing', 'is_reserved', 'is_sold', 'is_featured', 'pub_date']
